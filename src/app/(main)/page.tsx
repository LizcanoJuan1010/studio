    ...
    <div className="flex flex-col gap-8">
      ...
      <Card className="animate-fade-in" style={{ animationDelay: '200ms' }}>
          ...
          <CardContent className="space-y-4 text-muted-foreground">
              ...
              <div>
                <h3 className="font-semibold text-foreground mb-2">Objetivo general:</h3>
                <p>Construir un modelo de clasificación de frutas a partir del dataset Fruits-360, aplicando enfoques de aprendizaje de máquina y criterios básicos de evaluación.</p>
              </div>
              <div>
                <h3 className="font-semibold text-foreground mb-2">Objetivos específicos:</h3>
